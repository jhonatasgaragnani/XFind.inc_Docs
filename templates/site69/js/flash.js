...
*/
	function initialise(content) {
		...
		$('.filter.gallery li a').click(function(){
			...
			var fadeOutTo = .1; //opacity value of the fadeOut
	...
	*/
	function createTopPanel(){
		var html = '<div class="toppanel"><div class="container"><div class="top_phrase sixteen columns">This HTML5 Template comes with Several Combinations. Here are some of them.<a href="http://themeforest.net/item/flash-retina-ready-responsive-parallax-template/4659744?ref=Designare" class="buy-item">BUY ITEM &rArr;</a></div><ul class="variations_list"><li class="one-third column"><a href="http://designarethemes.com/themes/flash/fsimage-light"><img src="http://designarethemes.com/themes/flash/fsimage-blue/images/fs-light.png" alt="LIGHT VERSION"/></a></li><li class="one-third column"><a href="http://designarethemes.com/themes/flash/fsimage-dark"><img src="http://designarethemes.com/themes/flash/fsimage-blue/images/fs-dark.png" alt="DARK VERSION"/></a></li><li class="one-third column"><a href="http://designarethemes.com/themes/flash/fsimage-blue"><img src="http://designarethemes.com/themes/flash/fsimage-blue/images/fs-blue.png" alt="BLUE VERSION"/></a></li></ul></div></div><div class="toppanel_trigger"></div>';
		$('body').prepend(html);
